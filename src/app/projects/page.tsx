...
const ProjectsPage = () => {
  ...
  interface BadgeProps {
    // Other properties already defined in BadgeProps
    // ...
  
    // Add this line to include className
    className?: string;
  }
  ...
  const Projects = [
    ...
    },
    {
      ...
      description:
        "This is a platform for learning about cryptocurrency with many tools and features. It is a very big project. ",
